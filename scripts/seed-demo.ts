...
async function main() {
  ...
  // 1) Showcase — a broad sampler (banner WebGL distortion, galleries, columns)
  {
    ...
    pages.push({
      ...
      type: "landing",
      blocks: [
        { id: id(), type: "banner", source: "featured", photoId: null, headline: "The Showcase", subhead: "Everything the page builder can do", ctaLabel: "See the blocks", ctaHref: "/design-samples", height: "tall", overlay: "auto", imagePosition: "center", layout: "bottom-left", headlineFont: "sans", headlineSize: "lg", headlineTracking: "normal", headlineCase: "normal", buttonStyle: "solid", effect: "webgl-distortion" },
  ...
  // 2) Cinematic — the scroll-driven 3D gallery (the star effect)
  {
    ...
    pages.push({
      ...
      type: "portfolio",
      blocks: [
        { id: id(), type: "banner", source: "featured", photoId: null, headline: "Cinematic Scroll", subhead: "Scroll to fly through the frames in 3D", height: "full", overlay: "auto", imagePosition: "center", layout: "bottom-left", headlineFont: "sans", headlineSize: "lg", headlineTracking: "normal", headlineCase: "normal", buttonStyle: "solid", effect: "none" },
  ...
  // 4) The Studio — an editorial about-style page
  {
    ...
    pages.push({
      ...
      type: "about",
      blocks: [
        { id: id(), type: "banner", source: "featured", photoId: null, headline: "The Studio", subhead: "Portraits, places, and the light in between", height: "short", overlay: "auto", imagePosition: "center", layout: "bottom-left", headlineFont: "sans", headlineSize: "lg", headlineTracking: "normal", headlineCase: "normal", buttonStyle: "solid", effect: "none" },
        { id: id(), type: "columns", gap: "airy", columns: [
          [
