...
export const PAGE_TYPES: { value: PageType; label: string; hint: string }[] = [
  {
    value: "standard",
    label: "Standard",
    hint: "A blank page with a heading and text.",
  },
  {
    value: "portfolio",
    label: "Portfolio",
    hint: "Banner, gallery, and a call to action.",
  },
...
const GALLERY_MOODBOARD_DEFAULTS = {
    ...
    case "about":
      return [
        ...
        },
        {
          id: gen(),
          type: "richtext",
          text: "Introduce yourself and your work here.",
          align: "left",
          font: "sans",
          size: "base",
        },
    ...
    case "contact":
      return [
        ...
        },
        {
          id: gen(),
          type: "richtext",
          text: "Tell visitors how to reach you.",
          align: "left",
          font: "sans",
          size: "base",
        },
...
export function homePresetBlocks(
  ...
  return [
    ...
    { id: gen(), type: "instagram", title: "From the field", count: 6 },
    {
      id: gen(),
      type: "cta",
      headline: "Photography that lasts",
      body: "Portraits, events, and the wild places in between — shot and delivered with care.",
