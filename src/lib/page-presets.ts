...
export function presetBlocks(type: PageType, gen: () => string): Block[] {
  switch (type) {
    case "portfolio":
      return [
        { id: gen(), type: "banner", source: "featured", photoId: null, headline: "Selected work", subhead: "", height: "tall", effect: "none" },
    ...
    case "landing":
      return [
        { id: gen(), type: "banner", source: "featured", photoId: null, headline: "", subhead: "", height: "tall", effect: "none" },
        {
          id: gen(),
          type: "columns",
          gap: "normal",
...
export function homePresetBlocks(
  ...
  return [
    { id: gen(), type: "banner", source: "featured", photoId: null, headline: opts.headline, subhead: opts.subhead, ctaLabel: "View portfolio", ctaHref: "/categories", height: "tall", effect: "none" },
