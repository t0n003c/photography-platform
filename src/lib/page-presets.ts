  ...
  switch (type) {
    case "portfolio":
      return [
        ...
        { id: gen(), type: "gallery", source: "featured", targetId: null, gridType: "masonry", spacing: "normal", autoplay: false, limit: 12, effect: "none", effectSpeed: 1 },
    ...
    case "landing":
      return [
        ...
        { id: gen(), type: "gallery", source: "featured", targetId: null, gridType: "justified", spacing: "normal", autoplay: false, limit: 9, effect: "none", effectSpeed: 1 },
...
export function homePresetBlocks(
  ...
  return [
    ...
    { id: gen(), type: "gallery", source: "featured", targetId: null, gridType: "justified", spacing: "normal", autoplay: false, limit: 12, effect: "none", effectSpeed: 1 },
