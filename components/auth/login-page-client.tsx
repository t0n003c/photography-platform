...
import type { LoginDesignConfig } from "@/src/lib/login-design";
...
export function LoginPageClient({
  ...
  const inputClass = loginControlClass(loginDesign);
  const primaryButtonClass = loginPrimaryButtonClass(loginDesign);
  const secondaryButtonClass = loginSecondaryButtonClass(loginDesign);
  const description =
    step === "credentials"
      ? loginDesign.subtitle
          ...
          {step === "credentials" ? (
            <form onSubmit={onCredentialsSubmit} className="space-y-4">
              ...
              >
                ...
                {loginDesign.primaryLabel || "Sign in"}
              </Button>
            </form>
          ) : bioOptions && !useCode ? (
            <div className="space-y-4">
          ...
          {step === "credentials" && (
            <>
              ...
              >
                ...
                {loginDesign.passkeyLabel || "Sign in with passkey"}
              </Button>
            </>
          )}
        </div>
